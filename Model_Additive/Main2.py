...
ax1_1.set_title("Case 2, n=1000", fontsize=10) # Set title and size
...
plt.ylim(-2,2) # Set vertical coordinate scale
ax1_2.set_title("Case 2, n=2000", fontsize=10) # Set title and size
...
ax2_1.set_title("Case 2, n=1000", fontsize=10) # Set title and size
...
plt.ylim(0,1) # Set vertical coordinate scale
ax2_2.set_title("Case 2, n=2000", fontsize=10) # Set title and size
...
#%% -----------Save all results------------
# ================figures======================
fig1.savefig('fig_g_2.jpeg', dpi=400, bbox_inches='tight')
fig2.savefig('fig_Lambda_2.jpeg', dpi=400, bbox_inches='tight')
