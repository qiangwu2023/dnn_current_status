...
def Est_additive(X_test,Z_train,X_train,U_train,De_train,Beta0,nodevec,m,c0,m0,nodevec0):
    Lambda_U = I_S(m, c0, U_train, nodevec)
    C_index = 0
    for loop in range(500):
        print('additive_iteration time=', loop)
        g_X = g_A(X_test,Z_train,X_train,De_train,Lambda_U,Beta0,m0,nodevec0)
        g_train = g_X['g_train']
